...
--Aquí cambiamos la columna fecha fin a null antes de insertar los datos ya que estaba como no nullable antes
alter table productores_básicos_de_electricidad modify fecha_fin null;

--Aquí insertamos valores a la tabla productores básicos de electricidad.
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('47','J6-T','arboleda S.A.','arboledagmail.com','11-jan-05',null);
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('58','J5-F','gloriante S.A.','gloriantegmail.com','12-feb-06','14-jul-22');
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('49','U4-F','victoria S.L.','victoriagmail.com','13-mar-05','15-jul-22');
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('12','YE-I','macs S.L.','macsgmail.com','14-apr-05','16-jul-22');
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('2','H9-J','acciona S.A.','accionagmail.com','15-may-07',null);
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('3','P5-J','energy S.A.','energygmail.com','16-may-05',null);
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('4','H7-H','gabilondo S.L.','gabilondogmail.com','17-aug-08',null);
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('5','H7-R',null,null,'11-jun-05','20-jul-22');
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('6','Y7-R','pepito S.A.','pepitogmail.com','19-sep-09','18-mar22');
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('89','Y2-U',null,null,'11-jun-05','20-jul-22');
insert into "PRODUCTORES_BÁSICOS_DE_ELECTRICIDAD" values ('1','H8-L','endesa S.A.','endesagmail.com','21-jan-05',null);
